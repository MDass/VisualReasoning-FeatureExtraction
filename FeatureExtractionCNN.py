...
class MultiscaleFeatureExtractor(nn.Module):
    ...
    def forward(self, x):
        ...
        conv5_1x1 = self.conv5_1x1(conv5_features)
        upsampled_conv5 = self.upsample2x(conv5_1x1)
        fused_conv4 = conv4_features + upsampled_conv5
        
        fused_conv4_1x1 = self.conv4_1x1(fused_conv4)
        upsampled_fused_conv4 = self.upsample2x(fused_conv4_1x1)
        fused_conv3 = conv3_features + upsampled_fused_conv4
...
def test(model, val_loader, device):
    ...
    all_labels = []
    classified_0 = 0
    misclassified_0 = 0 # predicted 0, true label 1
    classified_1 = 0
    misclassified_1 = 0 # predicted 1, true label 0
    ...
    epoch_acc = accuracy_score(all_labels, all_preds)
    return epoch_acc, classified_0, misclassified_0, classified_1, misclassified_1
...
if __name__ == "__main__":
    ...
    parser.add_argument('--loss_file', type=str, help='Filename of file containing losses', default='loss.txt')
    ...
    if args.test_only:
        ...
        epoch_acc, classified_0, misclassified_0, classified_1, misclassified_1 = test(model, test_loader, device)
    
        print(args.model_name)
        print(f"Accuracy: {epoch_acc}, Correctly classified 0's: {classified_0}, Predicted 0 (true: 1): {misclassified_0}, Correctly classified 1's: {classified_1}, Predicted 1 (true:0): {misclassified_1}")
